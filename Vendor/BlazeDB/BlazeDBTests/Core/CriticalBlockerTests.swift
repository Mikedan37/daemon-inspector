...
final class CriticalBlockerTests: XCTestCase {
    ...
    override func setUp() async throws {
        ...
        db = try BlazeDBClient(name: "blocker_test", fileURL: tempURL, password: "test-pass-123")
    }
    ...
    func testBlocker3_VACUUMRecovery_DetectsIncomplete() throws {
        ...
        XCTAssertNoThrow(
            try db = BlazeDBClient(name: "blocker_test", fileURL: tempURL, password: "test-pass-123"),
