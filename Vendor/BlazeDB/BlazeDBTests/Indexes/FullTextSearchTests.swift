...
final class FullTextSearchTests: XCTestCase {
    ...
    override func setUp() {
        ...
        db = try! BlazeDBClient(name: "search_test_\(testID)", fileURL: tempURL, password: "test-pass-123")
    }
    ...
    func testSearchPerformanceOn10k() throws {
        ...
        XCTAssertLessThan(duration, 1.0, "Search on 10k records should be < 1s")
    }
    ...
    func testSearchWithFilterPerformance() throws {
        ...
        XCTAssertLessThan(duration, 0.5, "Filtered search should be fast")
    }
