...
final class DistributedSecurityTests: XCTestCase {
    ...
    override func setUp() async throws {
        ...
        db1 = try BlazeDBClient(name: "db1", at: db1URL, password: "password1")
        db2 = try BlazeDBClient(name: "db2", at: db2URL, password: "password2")
    ...
    func testAuthentication_InvalidToken_Fails() {
    ...
    func testAuthentication_NoTokenWhenRequired_Fails() {
    ...
    func testReplayProtection_DuplicateOperation_Rejected() async throws {
        let nodeId = UUID()
        let timestamp = LamportTimestamp(counter: 1, nodeId: nodeId)
