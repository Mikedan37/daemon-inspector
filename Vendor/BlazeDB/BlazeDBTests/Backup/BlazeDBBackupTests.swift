...
final class BlazeDBBackupTests: XCTestCase {
    ...
    override func setUp() async throws {
        ...
        db = try BlazeDBClient(name: "BackupTest", fileURL: dbURL, password: "test-pass-123456")
    }
    ...
    func testBackupPreservesEncryption() async throws {
        ...
        XCTAssertEqual(restored[0].storage["ssn"]?.stringValue, "123-45-6789")
    ...
    func testExportImportRoundTrip() async throws {
        ...
        let newDB = try BlazeDBClient(name: "RoundTrip", fileURL: newDBURL, password: "test-pass-123456")
    ...
    func testBackupWithIndexes() async throws {
        ...
        BlazeDBClient.clearCachedKey()
        let restoredDB = try BlazeDBClient(name: "Restored", fileURL: backupURL, password: "test-pass-123456")
