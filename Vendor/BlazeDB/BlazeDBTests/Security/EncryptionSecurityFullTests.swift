...
final class EncryptionSecurityFullTests: XCTestCase {
    ...
    func testSecurity_DataEncryptedOnDisk() throws {
        ...
        db = try BlazeDBClient(name: "Security", fileURL: dbURL, password: "test-pass-123456")
    ...
    func testSecurity_EachPageHasUniqueNonce() throws {
        ...
        db = try BlazeDBClient(name: "NonceTest", fileURL: dbURL, password: "test-pass-123456")
    ...
    func testSecurity_AuthenticationTagPreventsModification() throws {
        ...
        db = try BlazeDBClient(name: "AuthTest", fileURL: dbURL, password: "test-pass-123456")
    ...
    func testSecurity_MetadataAlsoProtected() throws {
        ...
        db = try BlazeDBClient(name: "MetaTest", fileURL: dbURL, password: "test-pass-123456")
    ...
    func testEncryption_UpdatePreservesEncryption() throws {
        ...
        db = try BlazeDBClient(name: "UpdateTest", fileURL: dbURL, password: "test-pass-123456")
    ...
    func testEncryption_CrashRecoveryWithEncryption() throws {
        ...
        var db: BlazeDBClient? = try BlazeDBClient(name: "CrashTest", fileURL: dbURL, password: "test-pass-123456")
        ...
        // Recovery
        BlazeDBClient.clearCachedKey()
        db = try BlazeDBClient(name: "CrashTest", fileURL: dbURL, password: "test-pass-123456")
    ...
    func testPerformance_EncryptionThroughput() throws {
        measure(metrics: [XCTClockMetric(), XCTMemoryMetric()]) {
            ...
            let testDB = try! BlazeDBClient(name: "Perf", fileURL: testURL, password: "test-pass-123456")
