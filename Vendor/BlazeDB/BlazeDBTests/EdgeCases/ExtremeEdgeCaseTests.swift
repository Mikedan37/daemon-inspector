...
final class ExtremeEdgeCaseTests: XCTestCase {
    ...
    override func setUp() async throws {
        ...
        db = try BlazeDBClient(name: "ExtremeTest", fileURL: dbURL, password: "test-pass-123456")
    }
    ...
    func testDatabaseInNestedDirectory() throws {
        ...
        let nestedDB = try BlazeDBClient(name: "Nested", fileURL: nestedURL, password: "test-pass-123456")
    ...
    func testDatabasePathWithSpaces() throws {
        ...
        let spaceDB = try BlazeDBClient(name: "Spaces", fileURL: spaceURL, password: "test-pass-123456")
