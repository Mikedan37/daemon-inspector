...
final class BatchOperationTests: XCTestCase {
    ...
    override func setUp() {
        ...
        db = try! BlazeDBClient(name: "batch_test_\(testID)", fileURL: tempURL, password: "test-pass-batch-123")
    ...
    func testIndividualVsBatchInsertPerformance() throws {
        ...
        let individualDB = try BlazeDBClient(name: "individual", fileURL: individualURL, password: "test-pass-123")
        ...
        let batchDB = try BlazeDBClient(name: "batch", fileURL: batchURL, password: "test-pass-123")
