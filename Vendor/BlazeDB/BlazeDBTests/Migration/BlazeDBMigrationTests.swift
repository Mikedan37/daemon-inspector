...
final class BlazeDBMigrationTests: XCTestCase {
    ...
    func testAddRemoveRenameFieldsMigration() throws {
        ...
        do {
            let db = try BlazeDBClient(name: dbName, fileURL: fileURL, password: "test1234")
        ...
        let db2 = try BlazeDBClient(name: dbName, fileURL: fileURL, password: "test1234")
    ...
    func testBackupBeforeMigration() throws {
        ...
        var db = try BlazeDBClient(name: "BackupTestDB_\(testID)", fileURL: fileURL, password: "backupme")
        _ = try db.insert(BlazeDataRecord(["x": .int(1)]))
        
        // Reopen - migration happens automatically
        db = try BlazeDBClient(name: "BackupTestDB_\(testID)", fileURL: fileURL, password: "backupme")
    ...
    func testMigrationRemoveField() throws {
        ...
        let db = try BlazeDBClient(name: "RemoveFieldTest_\(testID)", fileURL: fileURL, password: "test1234")
    ...
    func testMigrationRenameField() throws {
        ...
        let db = try BlazeDBClient(name: "RenameFieldTest_\(testID)", fileURL: fileURL, password: "test1234")
    ...
    func testMigrationChangeFieldType() throws {
        ...
        let db = try BlazeDBClient(name: "TypeChangeTest_\(testID)", fileURL: fileURL, password: "test1234")
    ...
    func testMigrationRollbackOnFailure() throws {
        ...
        let db = try BlazeDBClient(name: "RollbackTest_\(testID)", fileURL: fileURL, password: "test1234")
    ...
    func testMigrationPreservesIndexes() throws {
        ...
        var db: BlazeDBClient? = try BlazeDBClient(name: "IndexPreserveTest_\(testID)", fileURL: fileURL, password: "test1234")
        ...
        db = try BlazeDBClient(name: "IndexPreserveTest_\(testID)", fileURL: fileURL, password: "test1234")
    ...
    func testMigrationWith10kRecords() throws {
        ...
        let db = try BlazeDBClient(name: "LargeMigrationTest_\(testID)", fileURL: fileURL, password: "test1234")
    ...
    func testConcurrentMigrationsPrevented() throws {
        ...
        let db = try BlazeDBClient(name: "ConcurrentMigrationTest_\(testID)", fileURL: fileURL, password: "test1234")
    ...
    func testMigrationV1toV2toV3() throws {
        ...
        let db = try BlazeDBClient(name: "MultiStepTest_\(testID)", fileURL: fileURL, password: "test1234")
