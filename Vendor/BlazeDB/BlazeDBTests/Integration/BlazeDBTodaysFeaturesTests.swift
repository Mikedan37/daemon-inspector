...
final class BlazeDBTodaysFeaturesTests: XCTestCase {
    ...
    func testMetadataBatchingReducesDiskWrites() throws {
        let db = try BlazeDBClient(name: "BatchingTest", fileURL: tempURL, password: "test-password-123")
    ...
    func testExplicitPersistFlushesImmediately() throws {
        let db = try BlazeDBClient(name: "PersistTest", fileURL: tempURL, password: "test-password-123")
        ...
        let db2 = try BlazeDBClient(name: "PersistTest", fileURL: tempURL, password: "test-password-123")
    ...
    func testDeinitFlushesMetadata() throws {
        autoreleasepool {
            let db = try! BlazeDBClient(name: "DeinitTest", fileURL: tempURL, password: "test-password-123")
    ...
    func testRollbackRestoresBaseline() throws {
        let db = try BlazeDBClient(name: "BaselineTest", fileURL: tempURL, password: "test-password-123")
    ...
    func testDeleteRollbackRestoresRecord() throws {
        let db = try BlazeDBClient(name: "DeleteRollbackTest", fileURL: tempURL, password: "test-password-123")
    ...
    func testConcurrentWALWritesThreadSafe() throws {
        let db = try BlazeDBClient(name: "WALLockTest", fileURL: tempURL, password: "test-password-123")
    ...
    func testIndexBackupRestoreOnFailure() throws {
        let db = try BlazeDBClient(name: "IndexAtomicTest", fileURL: tempURL, password: "test-password-123")
        let collection = db.collection as! DynamicCollection
    ...
    func testTransactionIDsUseUUIDStrings() throws {
        ...
        let db = try BlazeDBClient(name: "UUIDTxTest", fileURL: uniqueURL, password: "test-password-123")
    ...
    func testTodaysImprovementsIntegration() throws {
        let db = try BlazeDBClient(name: "IntegrationTest", fileURL: tempURL, password: "test-password-123")
        let collection = db.collection as! DynamicCollection
        ...
        let db2 = try BlazeDBClient(name: "IntegrationTest", fileURL: tempURL, password: "test-password-123")
