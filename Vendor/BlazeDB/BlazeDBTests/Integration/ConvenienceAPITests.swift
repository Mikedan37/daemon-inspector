...
final class ConvenienceAPITests: XCTestCase {
    ...
    override func tearDown() {
        ...
        let testNames = ["TestDB", "TestDB2", "MyApp", "UserData"]
    ...
    func testConvenienceInit_ByNameOnly() throws {
        ...
        let db = try BlazeDBClient(name: "TestDB", password: "test1234")
    ...
    func testConvenienceInit_Failable() {
        ...
        let db = BlazeDBClient.create(name: "TestDB2", password: "test1234")
    ...
    func testConvenienceInit_WithProject() throws {
        ...
        let db = try BlazeDBClient(name: "MyApp", password: "test1234", project: "MyProject")
    ...
    func testDiscoverDatabases() throws {
        ...
        _ = try BlazeDBClient(name: "MyApp", password: "test1234")
        _ = try BlazeDBClient(name: "UserData", password: "test1234")
    ...
    func testRegisterDatabase() throws {
        let db = try BlazeDBClient(name: "MyApp", password: "test1234")
    ...
    func testRegisteredDatabases() throws {
        ...
        let db1 = try BlazeDBClient(name: "MyApp", password: "test1234")
        let db2 = try BlazeDBClient(name: "UserData", password: "test1234")
    ...
    func testIntegration_CreateAndDiscover() throws {
        ...
        // Open it again
        let db2 = try BlazeDBClient(name: "MyApp", password: "test1234")
        let fetched = try db2.fetch(id: id)
        
        XCTAssertNotNil(fetched, "Should be able to fetch record from reopened database")
        XCTAssertEqual(fetched?.int("value"), 42, "Value should match")
    }
    
    func testIntegration_MultipleDatabases() throws {
        // Create multiple databases
        let db1 = try BlazeDBClient(name: "App1", password: "test1234")
        let db2 = try BlazeDBClient(name: "App2", password: "test1234")
        ...
        XCTAssertEqual(fetched1?.string("app"), "1", "db1 should have app=1")
        XCTAssertEqual(fetched2?.string("app"), "2", "db2 should have app=2")
    }
}
