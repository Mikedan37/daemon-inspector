...
final class TopologyTests: XCTestCase {
    ...
    func testRegisterDatabase() async throws {
        ...
        let bugsDB = try BlazeDBClient(name: "Bugs", fileURL: bugsURL, password: "TopologyTestPassword123!")
    ...
    func testRegisterMultipleDatabases() async throws {
        ...
        let bugsDB = try BlazeDBClient(name: "Bugs", fileURL: bugsURL, password: "TopologyTestPassword123!")
        let usersDB = try BlazeDBClient(name: "Users", fileURL: usersURL, password: "TopologyTestPassword123!")
    ...
    func testLocalConnectionReadOnly() async throws {
        ...
        let bugsDB = try BlazeDBClient(name: "Bugs", fileURL: bugsURL, password: "TopologyTestPassword123!")
        let dashboardDB = try BlazeDBClient(name: "Dashboard", fileURL: dashboardURL, password: "TopologyTestPassword123!")
