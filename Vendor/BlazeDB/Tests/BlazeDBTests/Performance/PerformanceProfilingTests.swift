...
final class PerformanceProfilingTests: XCTestCase {
    ...
    override func setUp() {
        ...
        do {
            db = try BlazeDBClient(name: "profile_test", fileURL: tempURL, password: "PerformanceProfiling123!")
        } catch {
    ...
    func testProfile_ComplexQuery() throws {
        // Setup: Use batch insert for much faster insertion (10-100x faster!)
        ...
        // Profile only the query execution, not the setup
