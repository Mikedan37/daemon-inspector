...
final class MVCCPerformanceTests: XCTestCase {
    ...
    override func setUp() async throws {
        ...
        db = try BlazeDBClient(name: "mvcc_perf_test", fileURL: tempURL, password: "MVCCPerformanceTest123!")
    }
    ...
    func testPerformance_SingleInserts_1000() throws {
        ...
        // Should complete in reasonable time (relaxed threshold for MVCC overhead)
        XCTAssertLessThan(duration, 10.0, "Inserts should be fast (< 10s for 1000 records)")
