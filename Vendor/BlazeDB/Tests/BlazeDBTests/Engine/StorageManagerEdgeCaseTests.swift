...
final class StorageManagerEdgeCaseTests: XCTestCase {
    ...
    func testReloadDatabaseAfterModifications() throws {
        ...
        let db = try manager.mountDatabase(named: "ReloadTest", fileURL: url, password: "StorageManagerEdge123!")
    ...
    func testCurrentDatabaseAccessor() throws {
        ...
        // Mount database
        _ = try manager.mountDatabase(named: "CurrentTest", fileURL: url, password: "StorageManagerEdge123!")
