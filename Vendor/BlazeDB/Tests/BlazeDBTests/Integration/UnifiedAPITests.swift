...
final class UnifiedAPITests: XCTestCase {
    ...
    override func setUp() {
        ...
        do {
            db = try BlazeDBClient(name: "unified_test_\(testID)", fileURL: tempURL, password: "UnifiedAPITestPassword123!")
        } catch {
    ...
    func testJoinQuery_ReturnsJoinedResult() throws {
        ...
        let usersDB = try BlazeDBClient(name: "users", fileURL: usersURL, password: "UnifiedAPITestPassword123!")
    ...
    func testJoinQuery_CanFlattenToRecords() throws {
        ...
        let usersDB = try BlazeDBClient(name: "users2", fileURL: usersURL, password: "UnifiedAPITestPassword123!")
