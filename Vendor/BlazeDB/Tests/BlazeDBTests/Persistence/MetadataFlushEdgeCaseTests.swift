...
final class MetadataFlushEdgeCaseTests: XCTestCase {
    ...
    override func setUp() {
        ...
        do {
            db = try BlazeDBClient(name: "FlushTest", fileURL: tempURL, password: "MetadataFlushTest123!")
        } catch {
    ...
    func testFlushAtExact100Records() throws {
        ...
        let db2 = try BlazeDBClient(name: "FlushTest", fileURL: tempURL, password: "MetadataFlushTest123!")
    ...
    func testFlush99RecordsThenCrashRecovery() throws {
        ...
        // Reopen database
        let recovered = try BlazeDBClient(name: "FlushTest", fileURL: tempURL, password: "MetadataFlushTest123!")
    ...
    func testFlushWithIndexesPersistsBoth() throws {
        ...
        // Reopen and verify indexes work (auto-flush should have persisted everything)
        let db2 = try BlazeDBClient(name: "FlushTest", fileURL: tempURL, password: "MetadataFlushTest123!")
